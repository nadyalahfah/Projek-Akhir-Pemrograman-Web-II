...
$payment_methods = [
    ['id' => 'gopay',         'name' => 'GoPay',         'icon' => 'fa-mobile-screen-button', 'fee' => 0],
    ['id' => 'ovo',           'name' => 'OVO',           'icon' => 'fa-mobile-screen-button', 'fee' => 0],
    ['id' => 'dana',          'name' => 'DANA',          'icon' => 'fa-mobile-screen-button', 'fee' => 0],
    ['id' => 'bank-transfer', 'name' => 'Transfer Bank', 'icon' => 'fa-building-columns',     'fee' => 0],
...
<div id="device-banner" style="display:none;background:rgba(99,179,237,0.08);border-bottom:1px solid rgba(99,179,237,0.15);padding:7px 24px;text-align:center;font-size:12px;color:var(--text-secondary);">
    <i class="fas fa-fingerprint" style="color:var(--accent);margin-right:5px;"></i>
    Device ID kamu: <code id="banner-device-id" style="font-family:monospace;color:var(--accent);background:rgba(99,179,237,0.12);padding:1px 7px;border-radius:4px;margin:0 4px;"></code>
    <span style="color:var(--text-muted)">Riwayat transaksi tersimpan untuk perangkat ini</span>
</div>
